  ...
  return (
    <section className="py-32 relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 gs-reveal-up">
        <h2 className="text-5xl md:text-7xl font-heading font-extrabold text-white mb-6 tracking-tight">Your team deserves better.</h2>
        ...
        <MagneticButton>
          <div className="group relative inline-block">
            ...
            <button className="relative bg-white text-gray-950 font-bold text-lg px-10 py-5 rounded-full hover:scale-[1.02] transition-transform flex items-center gap-3">
...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#020305] pt-12 pb-8 overflow-hidden relative">
      {/* Live Activity Ticker */}
      <div className="w-full overflow-hidden relative mb-12 border-b border-white/5 pb-8 mask-image-linear">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center text-xs text-white/40 font-sans">
